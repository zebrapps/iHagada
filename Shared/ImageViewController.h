...
@interface ImageViewController : HagadaViewController {
	NSArray *images;
...
/* This function will finally reach the app delegate for rotating all the other view controllers and its already declared in ImageViewControllerHeb
@protocol ImageViewControllerDelegate
